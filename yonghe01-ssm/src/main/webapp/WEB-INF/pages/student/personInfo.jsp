...
<body">
	...
	-->
			...
			<div class="sidebar-wrapper">
				<div class="logo">
					<a href="#" class="simple-text"> 您的个人信息 </a>
				</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-5">
							<div class="card card-user">
								<div class="image">
									<img
										src="${pageContext.request.contextPath }/resources/TIM_admin/assets/img/background.jpg"
										alt="..." />
								</div>
								<div class="content">
									<div class="author">
										<img class="avatar border-white"
											src="${pageContext.request.contextPath }/resources/TIM_admin/assets/img/faces/face-2.jpg"
											alt="..." />
										<h4 class="title">
											<br /> <a><small>@email</small></a>
										</h4>
									</div>
										...
										<li>
											<div class="row">
												<div class="col-xs-3">
													<div class="avatar">
														<img
															src="${pageContext.request.contextPath }/resources/TIM_admin/assets/img/faces/face-0.jpg"
															alt="Circle Image"
										...
										<li>
											<div class="row">
												<div class="col-xs-3">
													<div class="avatar">
														<img
															src="${pageContext.request.contextPath }/resources/TIM_admin/assets/img/faces/face-1.jpg"
															alt="Circle Image"
															class="img-circle img-no-padding img-responsive">
													</div>
												</div>
										...
										<li>
											<div class="row">
												<div class="col-xs-3">
													<div class="avatar">
														<img
															src="${pageContext.request.contextPath }/resources/TIM_admin/assets/img/faces/face-3.jpg"
															alt="Circle Image"
															class="img-circle img-no-padding img-responsive">
													</div>
												</div>
									...
									<form>
										...
										<div class="text-center">
											<button type="button" onclick="saveAccountInfo()"
												class="btn btn-info btn-fill btn-wd">点击保存修改信息</button>
										</div>
...
function init(){
	...
	$.ajax({
		...
		success:function(data){
			...
			$("#account_id").attr("value", account_id);
				 ...
				 $.ajax(
	               {
	                ...
	                success: function (result) {
	                    ...
	                    window.location.href="${pageContext.request.contextPath }/personInfo";
