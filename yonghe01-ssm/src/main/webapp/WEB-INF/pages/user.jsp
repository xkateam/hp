...
<meta charset="UTF-8">
<title>有浮云</title>
<link rel="stylesheet" type="text/css" href="resources/statics/css/style.css"/>
</head>
<body>
...
<div class="auto-box">
	...
	<div class="index-tserver-ad">
		<div class="main-box">
			<ul>
				<li><img src="statics/images/tserver-ad-icon1.png">7*24*365 服务支持</li>
				<li><img src="statics/images/tserver-ad-icon2.png">灵活定制行业解决方案</li>
				<li><img src="statics/images/tserver-ad-icon3.png">秒级快速响应</li>
				<li><img src="statics/images/tserver-ad-icon4.png">VVIP 大客户服务</li>
				<li><img src="statics/images/tserver-ad-icon5.png">最高15天免费试用</li>
			</ul>
		</div>
	</div>
</div>
